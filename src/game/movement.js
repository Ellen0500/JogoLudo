import { BASE_POSITIONS, HOME_ENTRANCE, TURNING_POINTS, } from './constants';
...
const BASE_POS = BASE_POSITIONS;
const HOME_ENT = HOME_ENTRANCE;
const TURN_PTS = TURNING_POINTS;
export const getIncrementedPosition = (player, currentPosition, steps) => {
    // se estiver na base, não sai
    if (BASE_POS[player].includes(currentPosition))
        return null;
